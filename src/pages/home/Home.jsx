  ...
  return (
    ...
    >
      <div className="flex flex-col">
        <h3 className="font-krona text-[36px] bg-gradient-to-r from-primary-200 via-primary-100 to-primary-200 bg-clip-text text-transparent self-start text-start">
          We Are Solution Oriented
        </h3>
        <h1 className="font-montserrat text-[96px] font-bold bg-gradient-to-r from-secondary-pink via-secondary-purple to-secondary-cyan bg-clip-text text-transparent self-start text-start">
          Tech Agency
        </h1>
