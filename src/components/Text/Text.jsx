    ...
    <p
      className={twMerge(
        clsx(
          ...
          variant === "heading" &&
            `font-krona text-xl sm:text-4xl 3xl:text-2xl bg-gradient-to-r from-primary-200 via-primary-100 to-primary-200 bg-clip-text text-transparent self-start text-start`
        ),
        className
      )}
    >
