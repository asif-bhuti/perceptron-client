...
export const Card = ({ children }) => {
  return (
    <PopUp scale={0.05}>
      <div className="group w-full h-fit mobile:h-full p-0.5 rounded-lg bg-gradient-to-r from-secondary-pink via-secondary-purple to-secondary-cyan border-none transition-all ease-in-out">
