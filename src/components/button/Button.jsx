  ...
  return (
    ...
    >
      <span
        class={twMerge(
          clsx(
            "relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-primary-400      rounded-md group-hover:bg-opacity-0",
            variant === "primary" && "dark:bg-transparent text-primary-400"
          )
        )}
      >
        {children}
